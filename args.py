...
arch_group.add_argument('--hidden', type=int, default=48)

arch_group.add_argument('--num_head', type=int, default=1)
arch_group.add_argument('--num_encoder',type=int, default=1)

#TFS config
arch_group.add_argument('--lstm_hidden',type=int, default=48)
...
optim_group.add_argument('--now_epoch', default=0, type=int, metavar='N')
...
optim_group.add_argument('--argk', default=3, type=int)
...
arg_parser.add_argument('--downstream',default=1,type=float)
...
arg_parser.add_argument('--warmup',default='true',type=str)
arg_parser.add_argument('--phylimit',default='true',type=str)
