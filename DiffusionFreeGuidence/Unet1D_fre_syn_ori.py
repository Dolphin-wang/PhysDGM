...
from DiffusionFreeGuidence.Attetnion import crossAttention,crossFrequencyAttention,temporalFrequencyAttention,synTemporalBlock_ori
...
class UNet1D_fre_syn_ori(nn.Module):
    def __init__(
        self,
        dim,
        cond_drop_prob = 0.5,
        ...
        self.minusTrend = PreNorm(dim_out, synTemporalBlock_ori(dim_out, length // 2**(len(in_out)-ind-1)))
