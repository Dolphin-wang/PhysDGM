...
class ClassificationHead(nn.Sequential):
    def __init__(self, emb_size=100, seq_len =40, adv_classes=2, cls_classes=10):
        super().__init__()
...
class Discriminator(nn.Sequential):
    def __init__(self, 
        ...
        super().__init__(
            ...
            ClassificationHead(data_emb_size,seq_length, 1, n_classes)
        )